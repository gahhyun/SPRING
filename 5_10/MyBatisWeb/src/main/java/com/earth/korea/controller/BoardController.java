...
//		if(pageSize==null) pageSize=10;
	...
	public String remove(Integer bno, Integer page, Integer pageSize, RedirectAttributes rattr, HttpSession session) {
		...
		// 삭제 후 메시지가 한번만 나와야 함. => Model이 아닌 RedirectAttributes(addFlashAttribute)에 저장하면 메시지가 한번만 나옴. 
	...
	public String write(Model m) {
		...
		return "board";		//board.jsp 읽기와 쓰기에 사용. 글쓰기에 사용할 때 mode==new
	}
