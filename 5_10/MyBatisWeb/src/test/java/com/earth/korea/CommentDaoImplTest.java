...
public class CommentDaoImplTest {
	...
	public void delete() throws Exception{
		...
		CommentDTO commentDTO = new CommentDTO(1, 0, "힘을", "earth");
	...
	public void insert()throws Exception{
		...
		commentDTO = new CommentDTO(1, 0, "힘을 내라", "earth1");
		assertTrue(commentDao.insert(commentDTO)==1);
	...
	public void selectAll() throws Exception{
		...
		commentDTO = new CommentDTO(1, 0, "힘을내라", "earth2");
		assertTrue(commentDao.insert(commentDTO)==1);
		assertTrue(commentDao.count(1)==2);
